...
<body id="top">
  ...
  <header class="s-header">
    ...
    <nav class="header-nav-wrap">
      <ul class="header-nav">
      <li class="nav-item">
          <a class="nav-link" href='liste_courrier.php' title="LISTER LES COURRIERS"><i class="fa fa-list" aria-hidden="true"></i> LISTER LES COURRIERS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href='accueil_courrier.php' title="AJOUTER COURRIER"><i class="fa fa-plus" aria-hidden="true"></i> AJOUTER COURRIER</a>
        </li>
        <li class="nav-item">
